...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(300).withKI(0).withKD(6)
        .withKS(4).withKV(0).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(6).withKI(0).withKD(0)
        .withKS(0.25).withKV(0.133 /* 0.124 */);
    ...
    private static final Distance kWheelRadius = Inches.of(1.973);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.535889);
    private static final boolean kFrontLeftSteerMotorInverted = false;
    private static final boolean kFrontLeftEncoderInverted = false;

    public static final Distance kFrontLeftXPos = Inches.of(9.625);
    public static final Distance kFrontLeftYPos = Inches.of(9.625);

    // Front Right
    private static final int kFrontRightDriveMotorId = 40;
    private static final int kFrontRightSteerMotorId = 28;
    private static final int kFrontRightEncoderId = 2;
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.0849609375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.421875);
